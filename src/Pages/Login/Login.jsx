...
const Login = () => {
  ...
  return (
    <div className="flex m-2 flex-col min-h-screen justify-center items-center">
      <h1 className="text-4xl mb-2 text-primary font-bold">Login to EcoTrack!</h1>
      <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
        <div className="card-body">
          <form onSubmit={handleSignIn} className="fieldset">
            ...
            <button onClick={handleSignInGoogle} type="button" className="btn bg-white text-black border-[#e5e5e5] mt-2">
